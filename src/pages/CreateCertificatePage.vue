                ...
                <div class="container">
                    <div class="row border-bottom mb-3 ">
                        <div class="col-12">
                            <div class="title">Sertifikatlashtirish
                                <p> O’quvchini malumotlarini kiriting</p></div>
                        </div>
                    </div>
                    <div class="row w-100 d-flex justify-content-center  align-items-center border-bottom pb-3 ">
                        <div class="col-12  col-md-4 "><label for="inputGiveName" class="label-title"> O’quvchining ismi
                           <p>Sertifikat egasini isim sharifini kiriting</p></label></div>
                        <div class="col-12 col col-md-8"><input v-model="Certification.givenName" type="text"
                                                                id="inputGiveName" placeholder="John"
                                                                class="form-control "></div>
                    </div>
                    <div class="row w-100 d-flex justify-content-center  align-items-center border-bottom pb-3 ">
                        <div class="col-12  col-md-4 "><label for="inputFamilyName" class="label-title"> O’quvchining familiyasi
                             <p>Sertifikat egasini familyasini kiriting</p></label></div>
                        <div class="col-12 col col-md-8"><input v-model="Certification.familyName" type="text"
                                                                id="inputFamilyName" placeholder="Doe"
                                                                class="form-control "></div>
                    </div>
                    <div class="row w-100 d-flex justify-content-center  align-items-center border-bottom pb-3 pt-3 ">
                        <div class="col-12  col-md-4 "><label for="inputEmail" class="label-title"> Pochta <p>O’quvchini
                            pochtasini kiriting</p></label></div>
                        <div class="col-12 col col-md-8"><input v-model="Certification.email" type="text"
                                                                id="inputEmail" placeholder="example@mail.com"
                                                                class="form-control "></div>
                    </div>
                    <div class="row w-100 d-flex justify-content-center  align-items-center border-bottom pb-3 pt-3">
                        <div class="col-12  col-md-4"><label for="courseName" class="label-title"> Kurs nomini kiriting
                            <p>Qaysi kursni tamomlaganini kiriting</p></label></div>
                    ...
                    <div class="row w-100 d-flex justify-content-center align-items-center border-bottom pb-3 pt-3">
                        ...
                        <div class="col-12 col-md-8">
                            <textarea v-model="Certification.practiceDescription" class="form-control costom-textarea"
                    ...
                    <div class="row w-100 d-flex justify-content-center align-items-center border-bottom pb-3 pt-3">
                        <div class="col-12 col-md-4 align-self-start ">
                            <label for="protectionCertificate" class="label-title ">Certifikat himoyasi<p>Malumot
                                batafsil kiriting</p></label>
                        </div>
                        <div class="col-12 col-md-8">
                            <textarea v-model="Certification.certificateDefense" class="form-control costom-textarea"
                    ...
                    <div class="row w-100 d-flex justify-content-center  align-items-center border-bottom pb-3 ">
                        <div class="col-12  col-md-4 ">Kursni bitirgan vaqti
                            <p>Sertifikat egasining kursni tomomlagan vaqtini kiriting</p></div>
                        <div class="col-12 col col-md-8"><input v-model="Certification.courseFinishedDate" type="date"
                                                                class="form-control"></div>
                    </div>
                    <div class="row w-100 d-flex justify-content-end align-items-center pb-3 pt-3">
                        <div v-if="uploadedImage"
                             class="col-12 d-none col-md-2 d-md-flex justify-content-end align-self-start">
                            <img :src="uploadedImage" alt="uploadImage">
                        </div>
                        <div @click="triggerFileInput"
                             class="col-12 col-md-10 d-flex justify-content-end align-items-center">
